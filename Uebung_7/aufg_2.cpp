...
static void familytreePointer(Person* p){
    std::cout<<"parents"<<std::endl;
    for(int i=0; i<p->getParents().size(); i++)    {
        std::cout<< p->getParents()[i]->getName()+" " + p->getParents()[i]->getFirst_name()<<std::endl;
        }
...
static void familytreeReference(Person& p){
    std::cout<<"parents"<<std::endl;
    for(int i=0; i<p.getParents().size(); i++)    {
        std::cout<< p.getParents()[i]->getName()+" " + p.getParents()[i]->getFirst_name()<<std::endl;
        }
...
void familytreeMember(){
    std::cout<<"parents"<<std::endl;
    for(int i=0; i<parents.size(); i++)    {
        std::cout<< parents[i]->getName()+" " + parents[i]->getFirst_name()<<std::endl;
        }
    std::cout<<"siblings"<<std::endl;
    for(int i=0; i<siblings.size(); i++)    {
        std::cout<< siblings[i]->getName()+" " + siblings[i]->getFirst_name()<<std::endl;
        }
    std::cout<<"children"<<std::endl;
    for(int i=0; i<children.size(); i++)    {
        std::cout<< children[i]->getName()+" " + children[i]->getFirst_name()<<std::endl;
        }
    std::cout<<"spouse"<<std::endl;
    
    std::cout<< spouse->getName()+" " + spouse->getFirst_name()<<std::endl;
